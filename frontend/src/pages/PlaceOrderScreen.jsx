...
const stripePromise = loadStripe(
  "pk_test_51T8D4nAikxtrnry6HJoQtwDnljaxw5rS8TQsGzQ6LIzlPydXpWhvhq8o8dRhGdVqDyiAVyHqaER6aUfKwjhWsDwn00KZkF4zwF",
);
    ...
    <div className="page fade-up">
      ...
      >
          ...
          >
            ...
            {cartItems.map((item) => (
              ...
              >
                ...
                <span style={{ color: "#8a8278", fontSize: "0.9rem" }}>
                  {item.qty} × ${item.price}
                </span>
                <span
                  style={{
        ...
        >
          ...
          >
            <span>Items</span>
            <span style={{ color: "#e8e4dc" }}>${totalPrice}</span>
          </div>
          <div
            style={{
              display: "flex",
