    ...
    <div style={{ minHeight: "calc(100vh - 72px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 5vw" }}>
      <div className="fade-up" style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <h1 style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "2.6rem", fontWeight: 300, marginBottom: 8 }}>Welcome Back</h1>
          <p style={{ color: "#8a8278", fontSize: "0.9rem" }}>Sign in to your account to continue</p>
        </div>
        ...
        <p style={{ textAlign: "center", marginTop: 20, color: "#8a8278", fontSize: "0.9rem" }}>
          New customer?{" "}
          <Link to="/register" style={{ color: "#c9a84c", letterSpacing: "0.03em" }}>Create an account</Link>
        </p>
      </div>
    </div>
  );
